<?php
/**
* This file contains the AdminManageClients Class
* 
*/


/**
 * AdminManageClients is an extended PanelModel Class
 * 
...
class AdminManageClients extends PanelModel {
    ...
    */  
    function __construct($user,$db,$postArray,$pageTitle,$pageHead,$pageID){  
        $this->modelType='AdminManageClients';

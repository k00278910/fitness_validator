<?php
/**
* This file contains the ClientManageProfile Class
* 
*/
...
class ClientManageProfile extends PanelModel {
    ...
    */  
    function __construct($user,$db,$postArray,$pageTitle,$pageHead,$pageID){  
        $this->modelType='ClientManageProfile';
    ...
    public function setPanelHead_1(){
        $this->panelHead_1='<h3>Client Profile</h3>';      
    }

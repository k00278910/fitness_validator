<?php
/**
* This file contains the AdminManageRunWalkPlans Class
* 
*/


/**
 * AdminManageRunWalkPlans is an extended PanelModel Class
 * 
...
class AdminManageRunWalkPlans extends PanelModel {
    ...
    */  
    function __construct($user,$db,$postArray,$pageTitle,$pageHead,$pageID){  
        $this->modelType='AdminManageRunWalkPlans';

<?php
/**
* This file contains the AdminManageWalkPlans Class
* 
*/


/**
 * AdminManageWalkPlans is an extended PanelModel Class
 * 
...
class AdminManageWalkPlans extends PanelModel {
    ...
    */  
    function __construct($user,$db,$postArray,$pageTitle,$pageHead,$pageID){  
        $this->modelType='AdminManageWalkPlans';

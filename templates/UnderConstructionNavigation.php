<?php
/**
* This file contains the UnderConstructionNavigation Class
* 
*/
 ...
 * page navigation bar for a logged in [SPECIFY] user.  
 * 
...
class UnderConstructionNavigation implements NavigationInterface {
	...
	function __construct($user,$pageID) {               
            ...
            $this->modelType='TemplateNavigation';
            $this->user=$user;
            $this->pageID=$pageID;
            $this->setmenuNav();
	}

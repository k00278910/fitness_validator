<?php
 /**
 * File containing : PanelModel Class
 * .
 * 
 * 
 */
 ...
 * 
 * The PanelModel class is the parent abstract class for page content clasaes that
 * provide up to 3 page panels content.
 * 
...
abstract class PanelModel implements PanelModelInterface {
    ...
    /**
     *
     * @var String Contaiining the currently selected page ID 
     */
    protected $pageID; 
    ...
    public function getDiagnosticInfo(){
        echo '<div class="container-fluid"   style="background-color: #AAAAC0">'; //outer DIV
            echo '<h3>MODEL CLASS: '.$this->modelType.' - properties</h3>';
            echo '<table border=1 border-style: dashed; style="background-color: #EEEEE0" >';

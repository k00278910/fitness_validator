...
class User {
    ...
    /**
     *
     * @var String $collegeID containing User's college ID (employee or student number)
     */
    protected $userCollegeID;     
    ...
    function __construct($session,$database,$encryptPW) {   
        ...
        $this->userCollegeID=$session->getUserCollegeID();
     ...
     * @return string
     */
    public function getUserCollegeID(){return $this->userCollegeID;}
    ...
    public function getDiagnosticInfo(){
        echo '<div class="container-fluid"   style="background-color: #AAAAAA">'; //outer DIV
            ...
            echo "<tr><td>userCollegeID  </td><td>$this->userCollegeID       </td></tr>";
